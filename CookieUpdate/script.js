...
var paramterKey = ["Collection", "Prize"];
var dataKeyArray = [["1", "2", "3", "4", "5", "6", "7"], ["normal", "bonus"]];
//#endregion
...
//#region - WEBSITE URL -
var WebsiteURL = {
    title: "https://kypost.github.io/FoodTaipei_PointCard/",
    collect: "https://kypost.github.io/FoodTaipei_PointCard/Collect/",
}
//#endregion
...
var collectionParameter = GetURLParameter(paramterKey[0]);
...
// update prize data
if (data.status == UserStatus.Bonus || data.status == UserStatus.Normal) {
    var prizeParameter = GetURLParameter(paramterKey[1]);
...
// load website
if (data.status == 0)
    EntryTargetWebsite(WebsiteURL.title);
else
    EntryTargetWebsite(WebsiteURL.collect);
